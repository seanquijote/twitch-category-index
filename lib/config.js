...
/**
 * Absolute path to the canonical categories dataset file.
 *
 * @type {string}
 */
export const DATA_FILE = path.join(DATA_DIR, "index.json");
...
/**
 * Twitch Helix endpoint for fetching the list of top games/categories.
 *
 * @type {string}
 */
...
/**
 * Number of categories to request per page. 100 is the maximum the Twitch API allows.
 *
 * @type {number}
 */
